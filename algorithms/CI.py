...
class Robot_CI(Robot):
    ...
    def __init__(self, X, _id, NUM_ROBOTS, flag, LANDMARK_POS) -> None:
        ...
        '''
        assert(flag < 2, "only the observation model is at least relative position with flag<2, CI could be used")
        ...
        for LM_id in range(self.LANDMARK_NUM):
            ...
            if _range <= RB and abs(bearing) <= BB: # self->LM_id
                ...
                if(self.flag>=0):
                    ...
                    self.Z_landmark[LM_id] = (X2_ + measure_noises[LM_id,:]).reshape(1, 3)
    ...
    def measurement_rela(self, cla_trues, measure_noises, measure_bias_whether=[]):
        ...
        for r in range(self.NUM_ROBOTS):
            ...
            _range, bearing, X2_ = parameters.measurement(cla_trues[r].X_true, My_true)
